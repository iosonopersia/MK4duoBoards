...
public class EditingTabPane extends TabPane {
	...
	private ServosPinsTab servosPinsTab;
	...
	public EditingTabPane(DataManager model, i18n lang){
		...
		servosPinsTab= new ServosPinsTab(model, lang);
		unknownPinsTab= new UnknownPinsTab(model, lang);
		ifBlocksTab= new IfBlocksTab(model, lang);
		
		getTabs().addAll(metadataTab, mainPinsTab, extrudersPinsTab, servosPinsTab, unknownPinsTab, ifBlocksTab);
	}
	...
	public final ServosPinsTab getServosPinsTab() {
		return servosPinsTab;
	}
